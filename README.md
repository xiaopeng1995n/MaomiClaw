...
[![GitHub 仓库](https://img.shields.io/badge/GitHub-仓库-black.svg?logo=github)](https://github.com/xiaopeng1995n/MaomiClaw)
...
[![最后提交](https://img.shields.io/github/last-commit/agentscope-ai/CoPaw)](https://github.com/xiaopeng1995n/MaomiClaw)
...
[![GitHub Star](https://img.shields.io/github/stars/agentscope-ai/CoPaw?style=flat&logo=github&color=yellow&label=Star)](https://github.com/xiaopeng1995n/MaomiClaw/stargazers)
[![GitHub Fork](https://img.shields.io/github/forks/agentscope-ai/CoPaw?style=flat&logo=github&color=purple&label=Fork)](https://github.com/xiaopeng1995n/MaomiClaw/network)
...
>
> <details>
> <summary><b>你可以用 猫咪Claw 做什么</b></summary>
>
> <br>
>
...
在浏览器打开 **http://127.0.0.1:8088/** 即可使用控制台（与 猫咪Claw 对话、配置 Agent）。若要在钉钉、飞书、QQ 等 app 内对话，请在 [文档](https://copaw.agentscope.io/docs/channels) 中接入频道。
...
CoPaw 在开放协作中持续演进，欢迎各种形式的参与！请参考上方 [路线图](#路线图)（尤其是标记为 **征集中** 的项）选择你感兴趣的方向，并阅读 [CONTRIBUTING](https://github.com/xiaopeng1995n/MaomiClaw/blob/main/CONTRIBUTING_zh.md) 了解如何开始。我们特别欢迎：

- **横向拓展** — 新频道、模型提供商、Skills、MCP。
- **已有功能扩展与完善** — 展示与交互优化、下载提示、Windows 路径兼容等。

欢迎在 [GitHub Discussions](https://github.com/xiaopeng1995n/MaomiClaw/discussions) 参与讨论、提出想法或认领任务。
...
```bash
git clone https://github.com/xiaopeng1995n/MaomiClaw.git
cd CoPaw
pip install -e .
```
...
<a href="https://github.com/xiaopeng1995n/MaomiClaw/graphs/contributors">
