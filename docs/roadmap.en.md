...
We are building CoPaw in the open and welcome contributions of all kinds! Check the table above (especially items marked **Seeking Contributors**) to find areas that interest you, and read [CONTRIBUTING](https://github.com/xiaopeng1995n/MaomiClaw/blob/main/CONTRIBUTING.md) to get started. We particularly welcome:
...
Join the conversation on [GitHub Discussions](https://github.com/xiaopeng1995n/MaomiClaw/discussions) to suggest or pick up work.
