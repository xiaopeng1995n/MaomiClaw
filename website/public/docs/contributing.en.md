...
We also encourage you to contribute according to our [Roadmap](/docs/roadmap): items marked **Seeking Contributors** (e.g. new channels, model providers, skills, MCPs, or display/UX improvements) are great places to start. Check the roadmap for current focus and long-term plans, then join the conversation on [GitHub Discussions](https://github.com/xiaopeng1995n/MaomiClaw/discussions).
